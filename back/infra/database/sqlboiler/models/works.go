...
type Work struct {
	...
	ThumbnailName null.String `boil:"thumbnail_name" json:"thumbnail_name,omitempty" toml:"thumbnail_name" yaml:"thumbnail_name,omitempty"`
	// 作品の表示順序を管理するインデックス。デフォルトは-1
	SortIndex int       `boil:"sort_index" json:"sort_index" toml:"sort_index" yaml:"sort_index"`
	GithubURL string    `boil:"github_url" json:"github_url" toml:"github_url" yaml:"github_url"`
...
var WorkTableColumns = struct {
	...
	ID:            "works.id",
	Title:         "works.title",
	ThumbnailName: "works.thumbnail_name",
	SortIndex:     "works.sort_index",
	GithubURL:     "works.github_url",
...
var WorkWhere = struct {
	...
	ThumbnailName whereHelpernull_String
	SortIndex     whereHelperint
	GithubURL     whereHelperstring
	...
	ThumbnailName: whereHelpernull_String{field: "`works`.`thumbnail_name`"},
	SortIndex:     whereHelperint{field: "`works`.`sort_index`"},
	GithubURL:     whereHelperstring{field: "`works`.`github_url`"},
...
var (
	workAllColumns            = []string{"id", "title", "thumbnail_name", "sort_index", "github_url", "created_at", "updated_at", "deleted_at", "user_id"}
	workColumnsWithoutDefault = []string{"id", "title", "thumbnail_name", "github_url", "deleted_at", "user_id"}
	workColumnsWithDefault    = []string{"sort_index", "created_at", "updated_at"}
