...
type UpdateCertificationsSortAction struct {
	uc certification.UpdateCertificationsSortUseCase
	v  validator.Validator
	l  logger.Logger
}

func NewUpdateCertificationsSortAction(
	uc certification.UpdateCertificationsSortUseCase,
	v validator.Validator, l logger.Logger,
) *UpdateCertificationsSortAction {
	return &UpdateCertificationsSortAction{
		uc: uc,
		v:  v,
		l:  l,
	}
...
func (a *UpdateCertificationsSortAction) Execute(w http.ResponseWriter, r *http.Request, c *gin.Context) {
	var input certification.UpdateCertificationsSortInput
	const logKey = "update_certifications_sort"
